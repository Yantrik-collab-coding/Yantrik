...
const S: Record<string, React.CSSProperties> = {
  ...
  sidebar: { width: 220, background: 'var(--bg1)', borderRight: '1px solid var(--border)', display: 'flex', flexDirection: 'column', padding: '20px 16px', gap: 8, flexShrink: 0 },
  logo: { display: 'flex', alignItems: 'center', gap: 8, padding: '4px 0 16px' },
  main: { flex: 1, overflow: 'auto', padding: 32 },
  heading: { fontSize: 28, fontWeight: 800, letterSpacing: '-0.02em' },
  sub: { color: 'var(--text-muted)', fontSize: 14, marginTop: 4, marginBottom: 28 },
  grid: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, maxWidth: 960 },
  card: { display: 'flex', flexDirection: 'column', gap: 14 },
  secTitle: { display: 'flex', alignItems: 'center', gap: 6, fontSize: 11, fontWeight: 700, textTransform: 'uppercase' as const, letterSpacing: '0.08em', color: 'var(--text-dim)', fontFamily: 'var(--font-mono)' },
  bigAvatar: { width: 52, height: 52, borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 20, fontWeight: 800, color: '#fff', flexShrink: 0 },
  miniAvatar: { width: 30, height: 30, borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 12, fontWeight: 700, color: '#fff' },
  planCard: { background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 10, padding: 16, display: 'flex', flexDirection: 'column' },
  planActive: { borderColor: 'var(--accent)', background: 'var(--accent-dim)' },
  notice: { marginTop: 10, padding: '10px 14px', background: '#f0a50011', border: '1px solid #f0a50033', borderRadius: 8, fontSize: 12, color: 'var(--text-muted)', lineHeight: 1.6 },
  code: { color: 'var(--accent)', fontFamily: 'var(--font-mono)' },
  label: { fontSize: 11, fontWeight: 700, color: 'var(--text-muted)', textTransform: 'uppercase' as const, letterSpacing: '0.06em', fontFamily: 'var(--font-mono)' },
}
