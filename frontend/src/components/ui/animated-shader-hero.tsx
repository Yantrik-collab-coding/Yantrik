...
const Hero: React.FC<HeroProps> = ({
  ...
  return (
    <div className={`relative w-full h-screen overflow-hidden bg-black ${className}`}>
      ...
      {/* Subtle dark vignette so text always reads over bright shader areas */}
      <div
      ...
      >
        ...
        {trustBadge && (
          <div className="mb-8 animate-fade-in-down">
            ...
            >
              ...
              <span className="text-teal-200">{trustBadge.text}</span>
            </div>
          </div>
        )}

        {/* Headline */}
        <div className="text-center space-y-1 max-w-5xl mx-auto mb-6">
          <h1
            className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tight animate-fade-in-up animation-delay-200 hero-text-shadow"
            style={{
              background: 'linear-gradient(135deg, #99f6e4 0%, #2dd4bf 40%, #34d399 100%)',
          ...
          <h1
            className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tight animate-fade-in-up animation-delay-400 hero-text-shadow"
            style={{
              background: 'linear-gradient(135deg, #5eead4 0%, #34d399 50%, #6ee7b7 100%)',
              WebkitBackgroundClip: 'text',
              WebkitTextFillColor: 'transparent',
              backgroundClip: 'text',
              lineHeight: 1.05,
        ...
        {/* Subtitle */}
        <div
          className="max-w-2xl mx-auto text-center animate-fade-in-up animation-delay-600 mb-10"
        >
          <p
          ...
          >
            {buttons.primary && (
              <button
                ...
                className="hero-btn-primary px-8 py-4 font-semibold text-base rounded-full transition-all duration-300"
                style={{
            ...
            {buttons.secondary && (
              <button
                ...
                className="hero-btn-secondary px-8 py-4 font-semibold text-base rounded-full transition-all duration-300"
                style={{
